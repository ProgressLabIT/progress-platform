...
| TLS at edge | Traefik + Let's Encrypt + optional custom-cert file provider (`km/security/https.md`) | External edge covered; internal mTLS missing |
