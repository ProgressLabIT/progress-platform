export default {
  ...
  "job": {
    ...
    "alerts": {
      ...
      "input_not_available": "Questo pezzo/lotto è stato completato, ma non c'è materiale disponibile per procedere con un altri pezzi, la sessione di lavoro verrà conclusa. Se ritieni che ciò non sia accurato contatta il tuo responsabile.",
      ...
      "next_batch_not_available": "Questo pezzo/lotto è stato completato, ma non è disponibile materiale per procedere con altri pezzi. Il lavoro verrà messo in pausa. Confermi?",
  ...
  "operation": {
    ...
    "alerts": {
      "delete_general_error": "Errore durante l'eliminazione dell'operazione. Per favore contatta l'amministratore di sistema.",
      "op_in_use": "L'operazione non può essere cancellata perché in uso nel processo dei seguenti prodotti",
      "op_name_missing": "indicare almeno un nome per l'operazione",
      "op_name_used": "nome operazione già in uso"
    },
    "default_params_explainer": "Le nuove fasi associate a questa operazione verranno create con i parametri indicati qui. Potrai modificare i parametri specifici della fase dopo la creazione.",
  ...
  "product": {
    ...
    "alerts": {
      "doc_name_exists": "esiste già un documento con nome {filename}, vuoi sostituirlo?",
      "save_before_exit": "Salva o annulla le modifiche in tutte le sezioni prima di uscire."
    },
  ...
  "session": {
    ...
    "lock_explainer": "La sessione è stata sospesa per la tua sicurezza o perché inattiva per più di {timeout} minuti o a causa di un ricaricamento della pagina. Inserisci la password per riprendere la sessione. Se vuoi cambiare utente, chiudi e inizia una nuova sessione.",
  ...
  "user": {
    ...
    "archive_explainer": "I dati dell'utente non verranno effettivamente eliminati ma solo archiviati: l'utente non verrà visualizzato negli elenchi, ma potrà essere ripristinato dalla sezione archivio e i suoi dati saranno inclusi nelle analisi di tracciabilità.",
    ...
    "reset_password_success": "Password reimpostata con successo. Prendi nota della password temporanea per l'utente. Non verrà mostrata di nuovo. Al prossimo accesso l'utente dovrà sostituirla con una privata.",
    "status_title": "stato",
    "surname": "cognome",
