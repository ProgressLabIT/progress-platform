export default {
  ...
  product: {
    ...
    export_template: 'Scarica template',
    import: {
      dialog_title: 'Importa Prodotti',
      drop_file_here: 'Trascina il file qui',
      or_click_to_browse: 'o fai clic per sfogliare',
      validate: 'Valida File',
      import: 'Importa Prodotti',
      clear_file: 'Rimuovi file selezionato',
      unexpected_error: 'Si è verificato un errore imprevisto. Riprova.',
      try_again: 'Riprova',
      validation_success: 'Validazione superata',
      created_count: 'Da creare',
      updated_count: 'Da aggiornare',
      validation_errors: 'Il file contiene {count} errore/i. Scarica il file degli errori e correggilo prima di reimportare.',
      ignored_columns_warning: 'Colonne ignorate (non nel contratto): {columns}',
      invalid_file_type: 'Sono accettati solo file .xlsx e .csv',
      import_success: 'Importazione completata',
      // Phase 3 — VAL-01 preview table:
      preview_title: 'Anteprima righe',
      preview_col_row: 'Riga #',
      preview_col_code: 'Codice prodotto',
      preview_col_action: 'Azione',
      preview_no_rows: 'Nessuna riga da visualizzare',
      preview_rows_per_page: 'Righe per pagina:',
      preview_pagination: '{first}-{last} di {total}',
      action_create: 'Crea',
      action_update: 'Aggiorna',
      action_error: 'Errore',
      action_skipped: 'Salta',
      // Phase 3 — delta count:
      skipped_count: 'Da saltare',
      // Phase 3 — VAL-02 error list:
      error_list_title: '{count} riga/e con errori — correggi prima di importare',
      // Phase 3 — VAL-04 summary panel:
      summary_title: 'Importazione completata',
      summary_created: 'Creati',
      summary_updated: 'Aggiornati',
      summary_skipped: 'Saltati',
      summary_errored: 'Errori',
      close: 'Chiudi',
    },
  },
  production: {
