export default {
  ...
  "issue_delete_confirm_question": "Deleting the issue will remove all data attached to it. Do you want to proceed?",
  ...
  "update_time_disabled": "Available if job is not active",
