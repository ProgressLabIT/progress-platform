export default {
  ...
  errors: {
    ...
    delete_err: 'Error deleting task',
    cancel_err: 'Error cancelling task',
  },
  ...
  printer: {
    ...
    offset_hint: 'Calibration offset in mm',
  ...
  phase: {
    ...
    label: 'procedure',
    issue_link_label: 'Phase (product specific)',
  ...
  print_template_copy: 'Copy template',
  print_template_copy_name: '{name} (COPY)',
  print_template_copy_error: 'Could not copy the template. Try again.',
  print_template_rename: 'Rename template',
  print_template_fields: 'Fields',
  print_template_barcodes: 'Barcodes',
  print_template_help: {
    title: 'Designer Help',
    overview: 'The template designer lets you build a PDF layout by placing fields on a base PDF. Use the left sidebar to add a field, then click it on the canvas to reposition or resize it. The right panel lets you configure each field — its content, link type, and formatting.',
    field_types_title: 'Field Types',
    field_type_text: 'A plain text box. Can show static text or a value linked from the context.',
    field_type_image: 'An image box. Can show a static image or one linked from the context.',
    field_type_template_string: 'A composite text built from multiple values using {{token}} placeholders. Tokens are replaced at print time.',
    field_type_barcode: 'A barcode or 2D code (QR Code, DataMatrix, Code 128, etc.).',
    link_types_title: 'Link Types',
    link_none: 'No link — the user fills in the value manually when printing.',
    link_preset: 'Preset — automatically filled from the print context (e.g. job code, serial number, current date).',
    link_custom_field: 'Custom Field — automatically filled from a custom field associated with the entity being printed.',
    link_template_expression: 'Template Expression — a composite string using {{token}} syntax. Multiple values are joined into a single text.',
    link_computed: 'Computed — a formula evaluated at print time. Supports arithmetic, string functions, date functions, and conditional logic.',
    token_syntax_title: 'Token Syntax',
    token_syntax: 'Tokens are written inside double curly braces and replaced with live values at print time:',
    token_field: 'value of another field in this template',
    token_preset: 'preset value from the print context',
    token_cf: 'custom field value',
    operators: 'Arithmetic: + − * /. Comparisons: == != < > <= >=. The + operator concatenates text when either side is not a number.',
    computed_title: 'Computed Field Functions',
    computed_intro: 'These built-in functions are available in Computed fields:',
    ...
    fn_concat: 'Joins all arguments into a single string',
    fn_upper: 'Converts to uppercase',
    fn_lower: 'Converts to lowercase',
    fn_split: 'Splits a string by a delimiter and returns the part at the given index (0-based)',
    fn_round: 'Rounds a number to the given decimal places (default: 0)',
    fn_abs: 'Absolute value',
    fn_ceil: 'Rounds up to the nearest integer',
    fn_floor: 'Rounds down to the nearest integer',
    fn_now: 'Returns the current date and time as an ISO string',
    fn_date: 'Builds a date from parts. Modes: Y (year), YM (year+month), YMD (year+month+day), YW (ISO year+week)',
    fn_format_date: 'Formats a date using a pattern. Tokens: YYYY MM DD HH mm ss IW (ISO week) IYYY (ISO week-year)',
    fn_date_add: 'Adds time to a date. Units: "years", "months", "days", "hours", "minutes". Use a negative amount to subtract.',
    fn_days_between: 'Returns the absolute number of days between two dates',
    fn_ymd: 'Extracts the year, month (1–12), or day from a date',
    fn_week: 'Returns the ISO 8601 week number of a date',
    fn_if: 'Returns the second argument when the condition is true, otherwise the third argument',
  },
  procedure: 'procedure',
  process: 'process',
  ...
  product: {
    ...
    import: {
      dialog_title: 'Import Products',
      drop_file_here: 'Drop file here',
      or_click_to_browse: 'or click to browse',
      validate: 'Validate File',
      import: 'Import Products',
      clear_file: 'Clear selected file',
      unexpected_error: 'An unexpected error occurred. Please try again.',
      try_again: 'Try again',
      validation_success: 'Validation passed',
      created_count: 'To create',
      updated_count: 'To update',
      validation_errors: 'File has {count} error(s). Download the error file and fix before re-importing.',
      ignored_columns_warning: 'Columns ignored (not in contract): {columns}',
      invalid_file_type: 'Only .xlsx and .csv files are accepted',
      import_success: 'Import complete',
      // Phase 3 — VAL-01 preview table:
      preview_title: 'Row Preview',
      preview_col_row: 'Row #',
      preview_col_code: 'Product Code',
      preview_col_action: 'Action',
      preview_no_rows: 'No rows to preview',
      preview_rows_per_page: 'Rows per page:',
      preview_pagination: '{first}-{last} of {total}',
      action_create: 'Create',
      action_update: 'Update',
      action_error: 'Error',
      action_skipped: 'Skip',
      // Phase 3 — aggregate counts delta:
      skipped_count: 'To skip',
      // Phase 3 — VAL-02 error list:
      error_list_title: '{count} row error(s) — fix before importing',
  ...
  task_cancel_confirmation: 'Are you sure you want to cancel this task?',
  task_cancel_success: 'Task canceled successfully',
  task_cancel_error: 'Error canceling task',
  ...
  task_activate: 'Activate task',
  task_deactivate: 'Deactivate task',
  task_suspend: 'Suspend task',
  task_suspend_confirmation: 'Are you sure you want to suspend this task?',
  task_suspend_success: 'Task suspended successfully',
  activate: 'activate',
  ...
  task_delete_confirmation: 'Are you sure you want to delete this task? This cannot be undone.',
  task_delete_confirmation_bulk: 'Are you sure you want to delete {count} task(s)?',
  task_delete_success: 'Task deleted successfully',
  task_delete_soft_warning: 'This task has history and has been hidden from results rather than permanently deleted.',
  task_bulk_delete_summary: '{hard} task(s) permanently deleted, {soft} hidden due to history, {fail} failed.',
  ...
  system_counters_button: 'System counters',
  system_counters_title: 'System counters',
  system_counters_tasks: 'Tasks',
  system_counters_movement_lists: 'Movement lists',
  system_counters_work_orders: 'Work orders',
  system_counters_counting_sessions: 'Count sessions',
  system_counters_positions: 'Positions',
  counter_help_title: 'How counters work',
  counter_help_intro:
    'A counter generates a code by joining a sequence of tokens. Each token is either a date/time placeholder, a tick number padded to N digits, or fixed text. The tick increments on every use.',
  counter_help_reset:
    'The reset frequency (none, day, week, month, year) controls when the tick rolls back to 1.',
  counter_help_legend_title: 'Token legend',
  counter_help_token_y: '2-digit year',
  counter_help_token_yyyy: '4-digit year',
  counter_help_token_g: 'ISO 8601 week-based year (4-digit)',
  counter_help_token_m: 'Month (01–12)',
  counter_help_token_v: 'ISO 8601 week number (01–53)',
  counter_help_token_w: 'Week number, Monday-first (00–53)',
  counter_help_token_d: 'Day of month (01–31)',
  counter_help_token_h: 'Hour, 24h (00–23)',
  counter_help_token_min: 'Minute (00–59)',
  counter_help_token_j: 'Day of year (001–366)',
  counter_help_token_tick: 'Tick padded to N digits',
  counter_help_token_literal: 'Any other token is inserted literally',
  counter_help_example: 'Example',
  ...
  serial_not_available_confirmation_message:
    'This serial is not available. Proceeding link the component without generating any warehouse movement. Do you want to continue?',
  ...
  warehouse: {
    ...
    consumption_options: {
      ...
      minimum_quantity: 'Minimum consumption quantity',
      minimum_quantity_if_negative: 'Consume only minimum quantity if inventory below zero',
    },
    position: {
      add: 'Add positions',
