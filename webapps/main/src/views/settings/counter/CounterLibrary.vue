<template>
  ...
  <div v-else class="row full-height">
    ...
    <BaseDialog :show="show_new_field_form" :no-backdrop-dismiss="false">
      <CounterNew @close="show_new_field_form = false" @created="getCounters">
      </CounterNew>
    </BaseDialog>
    ...
    <div v-if="data_ready" class="col full-height">
      <router-view :field="selected_field" @reload="getCounters"> </router-view>
    </div>
  </div>
</template>
